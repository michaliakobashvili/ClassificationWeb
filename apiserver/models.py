...
class Passcode(Base):
    ...
    def is_valid(self, num_classifications):
        ...
        return self.valid_until > curr_date and self.activated and (self.max_classifications is None or num_classifications < self.max_classifications)
...
class Classification(Base):
    ...
    classified_at = Column(Date, default=datetime.now().date())
